...
fastq_dir='/scratch/lfs/ebecerra/SCRIPTS/TYPHIMURIUM/fq_files/'
f_file='/scratch/lfs/ebecerra/SCRIPTS/TYPHIMURIUM/f_typm_file.txt'
r_file='/scratch/lfs/ebecerra/SCRIPTS/TYPHIMURIUM/r_typm_file.txt'

################################################
                                               #
job_name='Typm_Quality'                        #
                                               #
################################################
...
partner_file='/scratch/lfs/ebecerra/SCRIPTS/typm_quality/trim_galore_partner.sh'

########## Output ###############################################
o_dir='/scratch/lfs/ebecerra/SCRIPTS/TYPHIMURIUM/o_trim_galore/'

#In this directory the spades output is going to be stored
temp_dir='/scratch/lfs/ebecerra/SCRIPTS/typm_quality/temp/' #This directorie will be eliminated

#Log files storage folder

log_dir='/scratch/lfs/ebecerra/SCRIPTS/typm_quality/log/' #If not existent create new directory
err_dir='/scratch/lfs/ebecerra/SCRIPTS/typm_quality/log/'
...
do
qsub -N "${job_name}${contador}" "${partner_file}" -o "${log_dir}${job_name}${contador}.log" -e "${err_dir}${job_name}${contador}.err" \
